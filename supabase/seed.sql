...
values
  ('mia-thornton', 'Mia Thornton', 'Talent / Supper Club Host',
  ...
  ('leo-nakamura', 'Leo Nakamura', 'Talent / Brand Founder',
  ...
  ('amara-osei', 'Amara Osei', 'Talent / Caterer',
  ...
  ('tom-whitfield', 'Tom Whitfield', 'Talent',
  ...
  ('priya-chandra', 'Priya Chandra', 'Talent / Brand Founder',
  ...
  ('jordan-reyes', 'Jordan Reyes', 'Talent',
...
values
  ((select id from public.spaces where slug = 'the-loft-at-flinders-lane'),
   'Mia Thornton', 'Talent / Supper Club Host', 5,
  ...
  ((select id from public.spaces where slug = 'gertrude-street-bistro'),
   'Priya Chandra', 'Talent / Brand Founder', 5,
